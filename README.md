# Awesome Github CLI Extensions with stars
...
* [**poi**](https://github.com/seachicken/gh-poi) ⭐ 1,001 | 🐛 8 | 🌐 Go | 📅 2026-07-26 - Safely clean up your local branches.
...
* [**tidy**](https://github.com/HaywardMorihara/gh-tidy) ⭐ 62 | 🐛 16 | 🌐 Shell | 📅 2026-04-30 - Extension for tidying your Git workspace.
* [**subrepo**](https://github.com/teaglebuilt/gh-subrepo) ⭐ 0 | 🐛 10 | 🌐 Go | 📅 2025-11-24 - Extension for managing git submodules

## Github

* [**dash**](https://github.com/dlvhdr/gh-dash) ⭐ 12,302 | 🐛 95 | 🌐 Go | 📅 2026-08-01 - Extension to display a dashboard of PRs and issues - configurable with a beautiful UI.
...
* [**gei**](https://github.com/github/gh-gei) ⭐ 475 | 🐛 213 | 🌐 C# | 📅 2026-08-13 - Extension to help you move your enterprise to GitHub Enterprise Cloud.
* [**token**](https://github.com/Link-/gh-token) ⭐ 412 | 🐛 13 | 🌐 Go | 📅 2026-08-03 - Create an installation access token for a GitHub app from your terminal.
...
* [**image**](https://github.com/drogers0/gh-image) ⭐ 217 | 🐛 15 | 🌐 Go | 📅 2026-08-11 - Upload local images to GitHub from the terminal, producing user-attachments URLs that work in issues, PRs, and READMEs.
...
* [**milestone**](https://github.com/valeriobelli/gh-milestone) ⭐ 82 | 🐛 3 | 🌐 Go | 📅 2026-02-15 - GitHub CLI extension for managing milestones.
* [**label**](https://github.com/heaths/gh-label) ⭐ 68 | 🐛 2 | 🌐 Go | 📅 2022-01-20 - Extension for issue label management.
* [**bump**](https://github.com/johnmanjiro13/gh-bump) ⭐ 63 | 🐛 11 | 🌐 Go | 📅 2026-08-13 - Extension for bumping version of a repository.
* [**metrics**](https://github.com/hectcastro/gh-metrics) ⭐ 62 | 🐛 0 | 🌐 Go | 📅 2026-08-13 - Extension that provides summary pull request metrics.
...
* [**actions-status**](https://github.com/rsese/gh-actions-status) ⭐ 53 | 🐛 1 | 🌐 Go | 📅 2023-05-15 - An extension to view the overall health of an organization's use of actions.
* [**stars**](https://github.com/aymanbagabas/gh-stars) ⭐ 53 | 🐛 4 | 🌐 Go | 📅 2023-11-06 - GitHub stargazers in your terminal.
* [**attach**](https://github.com/sudosubin/gh-attach) ⭐ 36 | 🐛 0 | 🌐 Go | 📅 2026-08-13 - Upload files to GitHub user-attachments and get a URL from the terminal.
...
* [**reaction**](https://github.com/ccoVeille/gh-reaction) ⭐ 11 | 🐛 14 | 🌐 Go | 📅 2026-07-21 - View recent GitHub emoji reactions on your posts and repositories, or someone else's.
* [**gr**](https://github.com/sarumaj/gh-gr) ⭐ 9 | 🐛 3 | 🌐 Go | 📅 2026-08-13 - Pull, push and check status on multiple GitHub repositories at once.
* [**pulls**](https://github.com/AaronMoat/gh-pulls) ⭐ 6 | 🐛 0 | 🌐 Shell | 📅 2023-03-18 - View all open pull requests you have created.
* [**get-asset**](https://github.com/chmouel/gh-get-asset) ⚠️ Archived - Fetch an asset (ie: binary) from a GitHub release.
* [**org-users**](https://github.com/yermulnik/gh-org-users) ⭐ 4 | 🐛 0 | 🌐 Shell | 📅 2022-07-19 - GH CLI extension to list all GitHub Org users.
* [**copilot-review**](https://github.com/ChrisCarini/gh-copilot-review) ⭐ 3 | 🐛 0 | 🌐 Shell | 📅 2026-08-12 - Extension to request a [Copilot code review](https://github.blog/changelog/2025-04-04-copilot-code-review-now-generally-available/) on a PR.
* [**watch**](https://github.com/justincampbell/gh-watch) ⭐ 3 | 🐛 1 | 🌐 Go | 📅 2026-07-16 - Watch GitHub resources (PRs, commits, branches) for state changes.
...
* [**pr-todo**](https://github.com/Suree33/gh-pr-todo) ⭐ 1 | 🐛 1 | 🌐 Go | 📅 2026-08-12 - Extract TODO-style comments from pull request diffs.
...
* [**classroom**](https://github.com/github/gh-classroom) ⭐ 125 | 🐛 49 | 🌐 Go | 📅 2026-07-14 - Official extension for GitHub Classroom.
...
* [**org-members**](https://github.com/gh-cli-for-education/gh-org-members) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2022-10-12 - Obtain  information about the students of a GitHub classroom organization

## Tool

* [**markdown-preview**](https://github.com/yusukebe/gh-markdown-preview) ⭐ 875 | 🐛 9 | 🌐 Go | 📅 2026-05-21 - GitHub CLI extension to preview Markdown looks like GitHub.
...
* [**fire**](https://github.com/maximousblk/gh-fire) ⭐ 48 | 🐛 0 | 🌐 Shell | 📅 2023-03-09 - Extention that helps in the event of an emergency.
...
* [**difftool**](https://github.com/speedyleion/gh-difftool) ⭐ 21 | 🐛 12 | 🌐 Rust | 📅 2026-08-12 - Launches a difftool to show the differences of a pull request.
...
* [**collab-scanner**](https://github.com/nicokosi/gh-collab-scanner) ⭐ 7 | 🐛 2 | 🌐 Go | 📅 2026-08-13 - Extension that displays collaboration-related information about a repository.
...
* [**home**](https://github.com/norwd/gh-home) ⭐ 5 | 🐛 0 | 🌐 Shell | 📅 2026-05-13 - GitHub CLI extension to checkout main and pull.
* [**validate-repo**](https://github.com/govindsme/gh-validate-repo) ⭐ 2 | 🐛 0 | 🌐 Shell | 📅 2023-03-06 - Extension that validates a cloned reposiory against a list of checks.
* [**akf**](https://github.com/HMAKT99/gh-akf) ⭐ 1 | 🐛 0 | 🌐 Shell | 📅 2026-07-04 - The AI native file format. Stamp files with trust scores, provenance, and compliance metadata. Certify changed files, generate trust reports for PRs.
* [**lockvet**](https://github.com/matteo-sung/gh-lockvet) ⭐ 0 | 🐛 0 | 🌐 Go | 📅 2026-08-08 - Vet the PR you're standing in for dependency risk: reads lockfile changes (36 formats) and flags vulnerabilities, malware shapes, typosquats and tampering.
...
* [**chat**](https://github.com/vilmibm/gh-chat) ⭐ 15 | 🐛 1 | 🌐 Go | 📅 2023-03-27 - Chatting in the github cli.
* [**inspire**](https://github.com/lakuapik/gh-inspire) ⭐ 9 | 🐛 2 | 🌐 Shell | 📅 2022-11-07 - Get inspiration quotes from github cli.
